...
public class CallableStatementDt01 {
	...
	public static void main(String[] args) throws ClassNotFoundException, SQLException {
		...
		// 1.Example: Create a function which uses 2 parameters and returns the sum of
		// the parameters
		// 1.Step: Create function in SQL
		String sql1 = "CREATE OR REPLACE FUNCTION addf(a NUMBER, b NUMBER) " + "RETURN NUMBER IS " + "BEGIN "
				+ "RETURN a+b; " + "END;";
