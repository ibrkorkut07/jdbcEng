...
public class Execute01 {
	...
	public static void main(String[] args) throws ClassNotFoundException, SQLException{
		...
		// Type show connection on your sql to see your url
		// Connection con = DriverManager.getConnection("jdbc:oracle:thin:@localhost:1521/xe", "hr", "hr");  // try this unless it works
