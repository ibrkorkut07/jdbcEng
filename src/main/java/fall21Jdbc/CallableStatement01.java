...
public class CallableStatement01 {
	...
	/*
	 * In Java, if the return type of a method is "any data type" or "void" we name
	 * all as methods. But in SQL, if sth returns "any data" it is called
	 * "function", if sth does not return any data it is called "procedure"
	 */
	...
	public static void main(String[] args) throws ClassNotFoundException, SQLException {
		...
		// 1.Example: Create a function which uses 2 parameters and return the sum of
		// the parameters
		...
		// 4.Step:Use registerOutParameter() method for result container, and use set
